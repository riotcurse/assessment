...
#define SBK_QTWIDGETS_QLIST_QSCROLLERPTR_IDX                         13 // QList<QScroller* >
...
#define SBK_QTWIDGETS_QLIST_QREAL_IDX                                16 // const QList<qreal > &
#define SBK_QTWIDGETS_QVECTOR_INT_IDX                                17 // QVector<int >
#define SBK_QTWIDGETS_QLIST_QGRAPHICSWIDGETPTR_IDX                   18 // QList<QGraphicsWidget* >
#define SBK_QTWIDGETS_QLIST_QWIDGETPTR_IDX                           19 // QList<QWidget* >
#define SBK_QTWIDGETS_QLIST_QKEYSEQUENCE_IDX                         20 // const QList<QKeySequence > &
#define SBK_QTWIDGETS_QLIST_QACTIONPTR_IDX                           21 // QList<QAction* >
#define SBK_QTWIDGETS_QPAIR_QREAL_QPOINTF_IDX                        22 // QPair<qreal,QPointF >
#define SBK_QTWIDGETS_QLIST_QPAIR_QREAL_QPOINTF_IDX                  23 // QList<QPair< qreal,QPointF > >
#define SBK_QTWIDGETS_QPAIR_QREAL_QREAL_IDX                          24 // QPair<qreal,qreal >
#define SBK_QTWIDGETS_QLIST_QPAIR_QREAL_QREAL_IDX                    25 // QList<QPair< qreal,qreal > >
#define SBK_QTWIDGETS_QLIST_QRECTF_IDX                               26 // const QList<QRectF > &
#define SBK_QTWIDGETS_QLIST_QGRAPHICSVIEWPTR_IDX                     27 // QList<QGraphicsView* >
#define SBK_QTWIDGETS_QLIST_QABSTRACTBUTTONPTR_IDX                   28 // QList<QAbstractButton* >
...
#define SBK_QTWIDGETS_QLIST_QABSTRACTANIMATIONPTR_IDX                32 // QList<QAbstractAnimation* >
#define SBK_QTWIDGETS_QLIST_QABSTRACTSTATEPTR_IDX                    33 // const QList<QAbstractState* > &
#define SBK_QTWIDGETS_QLIST_QDOCKWIDGETPTR_IDX                       34 // const QList<QDockWidget* > &
#define SBK_QTWIDGETS_QLIST_INT_IDX                                  35 // const QList<int > &
#define SBK_QTWIDGETS_QLIST_QMDISUBWINDOWPTR_IDX                     36 // QList<QMdiSubWindow* >
#define SBK_QTWIDGETS_QLIST_QLISTWIDGETITEMPTR_IDX                   37 // QList<QListWidgetItem* >
#define SBK_QTWIDGETS_QMAP_QDATE_QTEXTCHARFORMAT_IDX                 38 // QMap<QDate,QTextCharFormat >
#define SBK_QTWIDGETS_QLIST_QTABLEWIDGETITEMPTR_IDX                  39 // QList<QTableWidgetItem* >
#define SBK_QTWIDGETS_QLIST_QTABLEWIDGETSELECTIONRANGE_IDX           40 // QList<QTableWidgetSelectionRange >
#define SBK_QTWIDGETS_QLIST_QWIZARD_WIZARDBUTTON_IDX                 41 // const QList<QWizard::WizardButton > &
