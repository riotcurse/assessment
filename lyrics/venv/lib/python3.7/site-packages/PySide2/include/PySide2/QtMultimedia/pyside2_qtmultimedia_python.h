...
#define SBK_QTMULTIMEDIA_QLIST_QREAL_IDX                             7 // QList<qreal >
#define SBK_QTMULTIMEDIA_QLIST_QSIZE_IDX                             8 // QList<QSize >
#define SBK_QTMULTIMEDIA_QLIST_QVIDEOFRAME_PIXELFORMAT_IDX           9 // QList<QVideoFrame::PixelFormat >
#define SBK_QTMULTIMEDIA_QPAIR_INT_INT_IDX                           10 // QPair<int,int >
...
#define SBK_QTMULTIMEDIA_QLIST_QCAMERA_FRAMERATERANGE_IDX            13 // QList<QCamera::FrameRateRange >
