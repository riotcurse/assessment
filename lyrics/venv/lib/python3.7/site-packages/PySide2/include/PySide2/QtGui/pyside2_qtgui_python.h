...
#define SBK_QTGUI_QLIST_QSCREENPTR_IDX                               39 // QList<QScreen* >
#define SBK_QTGUI_QLIST_QTEXTBLOCK_IDX                               40 // QList<QTextBlock >
#define SBK_QTGUI_QLIST_QTEXTFRAMEPTR_IDX                            41 // QList<QTextFrame* >
#define SBK_QTGUI_QSET_QBYTEARRAY_IDX                                42 // QSet<QByteArray >
#define SBK_QTGUI_QLIST_QOPENGLCONTEXTPTR_IDX                        43 // QList<QOpenGLContext* >
...
#define SBK_QTGUI_QVECTOR_UNSIGNEDLONGLONG_IDX                       46 // QVector<unsigned long long >
