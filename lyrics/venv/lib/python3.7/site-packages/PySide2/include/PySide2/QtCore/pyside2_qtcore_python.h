...
#define SBK_QJSONOBJECT_IDX                                          6
#define SBK_QPTRDIFF_IDX                                             7
#define SBK_QINTPTR_IDX                                              8
#define SBK_QCHAR_IDX                                                9
...
#define SBK_QTCORE_QLIST_QABSTRACTEVENTDISPATCHER_TIMERINFO_IDX      40 // QList<QAbstractEventDispatcher::TimerInfo >
...
#define SBK_QTCORE_QLIST_QABSTRACTSTATEPTR_IDX                       44 // const QList<QAbstractState* > &
