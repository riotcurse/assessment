...
#define SBK_QTNETWORK_QLIST_QDNSDOMAINNAMERECORD_IDX                 17 // QList<QDnsDomainNameRecord >
#define SBK_QTNETWORK_QLIST_QDNSHOSTADDRESSRECORD_IDX                18 // QList<QDnsHostAddressRecord >
#define SBK_QTNETWORK_QLIST_QDNSMAILEXCHANGERECORD_IDX               19 // QList<QDnsMailExchangeRecord >
#define SBK_QTNETWORK_QLIST_QDNSSERVICERECORD_IDX                    20 // QList<QDnsServiceRecord >
#define SBK_QTNETWORK_QLIST_QDNSTEXTRECORD_IDX                       21 // QList<QDnsTextRecord >
#define SBK_QTNETWORK_QLIST_QNETWORKCOOKIE_IDX                       22 // QList<QNetworkCookie >
